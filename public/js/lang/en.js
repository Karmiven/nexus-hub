...
window.__loadLang({
  ...
  join_chat: 'Join Chat',
  chat_join_error: 'Failed to join chat',
  ...
  profile_desc: 'Manage your avatar, account details and security.',
  ...
  admin_chart_players: 'Players Online',
  admin_chart_avg_players: 'Avg Online',
  admin_chart_peak_players: 'Peak Online',
  admin_chart_registrations: 'New Registrations',
  admin_chart_registrations_count: 'Registrations',
  ...
  admin_kpi_views: 'Views',
  admin_kpi_visitors: 'Visitors',
  admin_kpi_chat: 'Chat Messages',
  admin_kpi_uptime: 'Avg Uptime',
  admin_kpi_registrations: 'New Registrations',
  admin_kpi_peak_hour: 'Peak Hour',
  admin_kpi_vs_prev: 'vs previous period',
  ...
  admin_news_preview_empty: 'Fill in the title and content above to see a preview.',
  ...
  pve_th_node: 'Node',
  mon_eyebrow: 'system status',
  mon_rename: 'Rename',
  mon_rename_prompt: 'Enter new name:',
