...
window.__loadLang({
  ...
  chat_join_error: 'Не удалось войти в чат',
  ...
  admin_chart_players: 'Игроков онлайн',
  admin_chart_avg_players: 'Средний онлайн',
  admin_chart_peak_players: 'Пиковый онлайн',
  admin_chart_registrations: 'Новые регистрации',
  admin_chart_registrations_count: 'Регистрации',
  ...
  admin_kpi_views: 'Просмотров',
  admin_kpi_visitors: 'Посетителей',
  admin_kpi_chat: 'Сообщений в чате',
  admin_kpi_uptime: 'Средний аптайм',
  admin_kpi_registrations: 'Новых регистраций',
  admin_kpi_peak_hour: 'Пиковый час',
  admin_kpi_vs_prev: 'за предыдущий период',
  ...
  admin_server_desc_en: 'Описание (английский)',
  admin_server_desc_ru: 'Описание (русский)',
  admin_translate_from_en: 'Перевести с EN',
  admin_translate_auto_desc: 'Русский, румынский и немецкий переводы генерируются автоматически с английского через DeepL при сохранении.',
  admin_translate_write_manually: 'Написать вручную',
  admin_translate_note: 'Оставьте пустым — при сохранении текст переведётся с английского автоматически. Румынский и немецкий генерируются всегда.',
  admin_translate_empty: 'Сначала заполните текст на английском.',
  admin_translate_progress: 'Перевожу…',
  admin_translate_unconfigured: 'Авто-перевод не настроен. Добавьте ключ DeepL (DEEPL_API_KEY), чтобы включить его.',
  admin_translate_failed: 'Не удалось перевести. Попробуйте ещё раз.',
  ...
  admin_news_preview_empty: 'Заполните заголовок и текст выше, чтобы увидеть предпросмотр.',
  ...
  admin_settings_section_top: 'Верхняя шапка',
  admin_settings_section_bottom: 'Нижняя шапка (Footer)',
  ...
  pve_th_node: 'Нода',
  mon_eyebrow: 'статус системы',
  mon_rename: 'Переименовать',
  mon_rename_prompt: 'Введите новое имя:',
  ...
  // ── Shell / редизайн (концепт A) ──
  side_sections: 'Разделы',
  side_admin: 'Админ-панель',
  nav_overview: 'Обзор',
  nav_news: 'Новости',
  ...
  tick_servers_online: 'серверов онлайн',
  tick_players: 'игроков',
  tick_uptime: 'аптайм 30д',
  ov_eyebrow: 'главный экран',
  ov_title: 'Обзор',
  ov_sub: 'Сводка по всем разделам. Подробности — в разделах слева.',
  ...
  ov_open_chat: 'Открыть чат',
  ov_all_news: 'Все новости',
  ov_infra: 'Инфраструктура',
  news_eyebrow: 'лента новостей',
  news_sub: 'Закреплённые — сверху. Нажми, чтобы прочитать полностью.',
  srv_eyebrow: 'игровые серверы',
  chat_eyebrow: 'связь',
  copy: 'копир.',
  flash_invalid_role: 'Недопустимая роль',
  flash_cannot_change_own_role: 'Нельзя изменить собственную роль',
  flash_role_updated: 'Роль обновлена',
  admin_settings_overview_subtitle: 'Подзаголовок обзора',
  admin_settings_overview_subtitle_hint: 'Короткая строка под заголовком «Обзор» на главном экране.',
  adm_system: 'Система',
  admin_system_title: 'Система и журнал',
  admin_system_backups: 'Резервные копии БД',
  admin_system_backup_create: 'Создать бэкап',
  admin_system_backup_hint: 'Бэкапы создаются автоматически раз в сутки; хранятся 7 последних.',
  admin_system_no_backups: 'Бэкапов пока нет.',
  admin_th_file: 'Файл',
  admin_th_size: 'Размер',
  admin_th_created: 'Создан',
  admin_th_time: 'Время',
  admin_th_action: 'Действие',
  admin_th_details: 'Детали',
  download: 'Скачать',
  admin_system_log: 'Журнал действий',
  admin_system_log_empty: 'Действий администраторов пока не записано.',
  admin_system_cleanup: 'Очистить аналитику (90+ дней)',
  admin_system_cleanup_confirm: 'Удалить данные аналитики старше 90 дней?',
  flash_backup_created: 'Бэкап создан.',
  flash_backup_failed: 'Не удалось создать бэкап.',
  flash_cleanup_done: 'Старые данные аналитики очищены.',
  page_prev: 'Назад',
  page_next: 'Вперёд',
  admin_settings_discord: 'Уведомления в Discord',
  admin_settings_discord_webhook: 'Webhook URL',
  admin_settings_discord_webhook_hint: 'Настройки сервера → Интеграции → Вебхуки в вашем Discord. Оставьте пустым, чтобы отключить.',
  admin_settings_discord_status: 'Уведомлять, когда сервер падает или поднимается',
  admin_settings_discord_news: 'Уведомлять о публикации новости',
  admin_settings_translation: 'Авто-перевод (DeepL)',
  admin_settings_deepl_key: 'Ключ DeepL API',
  admin_settings_deepl_enter: 'Вставьте ваш ключ DeepL API',
  admin_settings_deepl_saved: '•••••••• — ключ сохранён',
  admin_settings_deepl_hint: 'Хранится в зашифрованном виде (AES-256-GCM). Новости и описания серверов, написанные на английском, автоматически переводятся на RU/RO/DE при сохранении. Ключи бесплатного тарифа оканчиваются на «:fx». Оставьте пустым, чтобы сохранить текущий ключ.',
  admin_settings_deepl_clear: 'Удалить сохранённый ключ (отключает авто-перевод)',
  flash_invalid_webhook: 'Некорректный URL Discord-вебхука.',
  ...
  srv_kpi_uptime24: 'Аптайм 24ч',
  srv_kpi_uptime7: 'Аптайм 7д',
  srv_kpi_peak: 'Пик игроков 24ч',
  srv_kpi_ping: 'Средний пинг',
  srv_info: 'Информация о сервере',
  srv_events: 'Последние события',
  srv_evt_up: 'Поднялся',
  srv_evt_down: 'Упал',
  ...
  twofa_status_on: '2FA включена для этого аккаунта.',
  twofa_status_off: '2FA не включена. Защитите аккаунт одноразовыми кодами.',
  twofa_enable: 'Включить 2FA',
  twofa_disable: 'Отключить 2FA',
  twofa_confirm: 'Подтвердить и включить',
  twofa_setup_hint: 'Добавьте этот секрет в приложение-аутентификатор (Google Authenticator, Aegis, 1Password…), затем подтвердите кодом.',
  twofa_open_app: 'Открыть в приложении-аутентификаторе',
  twofa_enter_code: '6-значный код',
  twofa_title: 'Двухфакторная аутентификация',
  twofa_prompt: 'Введите 6-значный код из приложения-аутентификатора.',
  twofa_verify: 'Проверить',
  flash_2fa_enabled: 'Двухфакторная аутентификация включена.',
  flash_2fa_disabled: 'Двухфакторная аутентификация отключена.',
